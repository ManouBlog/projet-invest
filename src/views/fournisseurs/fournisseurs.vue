...
<loading :active="isLoading" 
 ...
 <div class="container-fluid">
              ...
              <tr v-for="(item,index) in list_fournisseurs" :key="index">
                ...
                <td class="text-right">
                  <div class="dropdown dropdown-action d-flex justify-content-center flex-wrap">
                    <router-link :to="{name:'seePackageFournisseur',params:{id:item.id}}" class="btn m-1 bg-pen text-light">
                       <i class="bi bi-eye"></i>
                    </router-link>
                    <button id="buton" @click="show(item.id)" class="btn btn-lg m-1 bg-danger text-light">
    ...
    <div class="delete_personne" v-show="showMsg">
     ...
     <button class="bg bg-pen text-light my-3 border-0 rounded p-2 fw-bold" @click="delete_user">Supprimer</button>
