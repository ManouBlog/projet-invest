...
<loading :active="isLoading" 
  ...
  <div class="container-fluid">
        ...
        <div class="col-md-7 align-self-center text-end">
          <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb justify-content-end">
              <li class="fw-bold h3"><span>listes des packages</span></li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="row container-fluid">
          ...
          <table id="MyTableData" class="table" v-if="list_packages">
            ...
            <tbody>
              <tr v-for="(item,index) in list_packages" :key="index">
                ...
                <td class="text-right">
                  <div class="dropdown dropdown-action d-flex justify-content-center">
                    <router-link  :to="{name:'ModifierPackage',params:{id:item.id}}" class="btn bg-pen mx-4 bg-primary text-light">
                       <i class="bi bi-pencil-fill"></i>
                    </router-link>
                    <button  @click="show(item.id)" title="Supprimer" class="btn btn-lg bg-danger text-light">
     ...
     <button class="bg bg-pen text-light my-3 border-0 rounded p-2 fw-bold" @click="Supprime_Package(this.id_delete)">Supprimer</button>
